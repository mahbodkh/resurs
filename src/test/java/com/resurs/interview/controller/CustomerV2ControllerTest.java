...
import com.resurs.interview.contoller.CustomerV2Controller;
...
@WebMvcTest(CustomerV2Controller.class)
public class CustomerV2ControllerTest {
    @Autowired
    ...
    void testGetCustomer_found() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/customers/1001"))
    ...
    void testGetCustomer_notFound() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/customers/999"))
    ...
    void testGetCreditScore_found() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/customers/1001/score"))
                .andExpect(status().isOk())
    ...
    void testGetCreditScore_notFound() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/customers/999/score"))
                .andExpect(status().isNotFound());
    }
    ...
    void testRequestLoan_approved() throws Exception {
        ...
        mockMvc.perform(post("/api/v2/customers/10/loan"))
                .andExpect(status().isOk())
